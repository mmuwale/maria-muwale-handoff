  ...
  return (
    <section id="plan" className="bg-[#f6ecea] px-[7vw] py-20">
      <div className="mx-auto mb-[45px] max-w-[820px] text-center">
        ...
        <p className="reveal-up text-[17px] leading-[1.7] text-[#6f7b8e]">{timelineIntro.body}</p>
      </div>

      <div className="relative mx-auto max-w-[1100px]">
        <div className="reveal-line absolute inset-x-5 top-[38px] hidden h-px bg-[#d98f96]/50 min-[800px]:block" />
        <div className="reveal-group grid grid-cols-4 gap-3.5 max-[800px]:grid-cols-2">
          {timelineSteps.map((step) => (
            <div key={step.label} className="reveal-up relative rounded-[20px] bg-white p-5">
