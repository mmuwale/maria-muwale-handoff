      ...
      <div className="mx-auto grid max-w-[1100px] grid-cols-2 items-center gap-[7vw] max-[800px]:grid-cols-1">
        <div className="reveal-group">
          ...
          {about.paragraphs.map((paragraph) => (
            <p key={paragraph} className="reveal-up mt-4 text-[17px] leading-[1.75] text-[#536075]">
              {paragraph}
            </p>
          ))}
        </div>
        <div
          className={`${playfair.className} reveal-wipe border-l-4 border-[#d98f96] pl-[25px] text-[37px] leading-[1.2] text-[#06224a] max-[800px]:text-[30px]`}
        >
          {about.quotePrefix}
