 ...
 * askRight: acts + contacts) plus .askTail (spark rule, closer, hashtag)
 * and .baseline - site/index.html lines 215-243, 291-308. The reference's
 * askRight also carries a countdown box; this project's countdown was
 * moved to the opener earlier in the build, so it's deliberately not
 * duplicated here.
 */
export function Ask() {
  return (
